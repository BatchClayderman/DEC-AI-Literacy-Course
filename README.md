# DEC AI Literacy Course

- Link: [https://connect.digitaleducationcouncil.com/login/oidc/0d817c76-67c1-40bf-a5b4-62e59dd908da/9adafd12-20f4-4c1e-b8a6-0ed8f7c4450d](https://connect.digitaleducationcouncil.com/login/oidc/0d817c76-67c1-40bf-a5b4-62e59dd908da/9adafd12-20f4-4c1e-b8a6-0ed8f7c4450d)
- Date: From December 30th, 2025 (Tuesday) to February 28th, 2026 (Saturday)
...
#### M1Q2: Which of the following is a subset of AI that focuses on creating new content? Choose only ONE best answer. 
...
#### M1Q4: What is one of the applications of AI in personalisation within the retail industry? Choose only ONE best answer. 

- A. Spam email filtering
- B. Fraud detection
- C. Data entry automation
- **D. Customised product recommendations**

#### M1Q5: What is a benefit of using AI for inclusivity in customer service? Choose only ONE best answer. 

- A. Reducing costs
- B. Enhancing accessibility for disabled users
- C. Eliminating human jobs
- **D. Supporting users in multiple languages**

#### M1Q6: What is a common challenge associated with AI that relates to decision-making transparency? Choose only ONE best answer. 
...
#### M2Q1: Creating an Engaging Blog Post on Sustainable Travel. You are a content creator for a university sustainability club. You want AI to generate an engaging blog post on eco-friendly travel tips for students who travel on a budget. Which prompt would be the most effective? Choose only ONE best answer. 
...
#### M2Q5: Drafting a Social Media Campaign. You are tasked with creating a social media campaign to promote sustainable living to young adults. Which prompt would be the least effective for achieving this goal? Choose only ONE best answer. 
...
#### M4Q3: What is a potential risk of over-reliance on AI in creative tasks? Choose only ONE best answer. 
...
#### M5Q1: What is a key ethical concern when using AI in academic settings? Choose only ONE best answer. 

- A. Improved time management skill
- **B. Plagiarism and misrepresentation of work**
- C. Increased creativity in assignments
- D. Limited access to AI tools among students

#### M5Q2: Which level of AI use is characterised by clear violations of academic integrity? Choose only ONE best answer. 

- **A. Level 1: Prohibited AI Use**
- B. Level 2: Unethical AI Use
- C. Level 3: Ethical & Responsible AI Use
- D. Level 4: Advanced AI Integration

#### M5Q3: What does the 'E' in the LEAD Framework stand for? Choose only ONE best answer. 

- A. Engagement & Effort
- B. Ethical & Accountable
- C. Efficiency & Reliability
- **D. Ethical & Transparent**

#### M5Q4: What is a best practice for ensuring honesty in academic work when using AI? Choose only ONE best answer. 
...
#### M6Q1: What is the main difference between AI-dependent and AI-augmented professionals? Choose only ONE best answer. 
...
- A. Repetitive manual task execution
- **B. AI literacy and critical thinking**
- C. Complete reliance on AI for decision-making
- D. Memorising AI-generated content without questioning its accuracy.
